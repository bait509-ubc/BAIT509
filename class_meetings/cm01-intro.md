...
Besides asking questions and contributing to discussions in class, you are encouraged to ask questions online via [GitHub issues on the BAIT509 repo](https://github.com/vincenzocoia/BAIT509/issues). Feel free to ask about anything related to the course -- content, assessments, coding, jobs, etc. You are also encouraged to interact with these Issues:
...
This happens outside of BAIT 509, too. For example, you would do these things if you experience a (legitimate) problem with an R package, which will typically have a GitHub repo. See the [`ggplot2` Issues](https://github.com/tidyverse/ggplot2/issues) as an example.
