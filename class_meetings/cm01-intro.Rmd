...
Write a formula that gives a prediction of $Y$ from $X$. Generate data, and evaluate the MSE. Why is the MSE not zero, even though we know the true distribution of the data?

### Oracle classification

The distribution of the data is:
$$ X_1, X_2 \sim \text{Unif}(0,1), $$
and the distribution of $Y|(X_1,X_2)$ is

(something continuous in x1, at least for the proportion of one category)

(something binary in x2). 
